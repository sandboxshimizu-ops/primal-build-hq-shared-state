...
| TIME (JST) | FROM | TO | MESSAGE | STATUS |
| --- | --- | --- | --- | --- |
...
- The active writer updates the detailed Build HQ only after evidence is verified.
- Use the required task-return format in the PRIMAL controlling conversation.
